...
print("Let's find out if Alexa should buy apples or not!\n ")

budget = float(input("Enter your budget: "))
applePrice = float(input("Enter the price of apple: "))
print("\n ")
...
# Execute the block of code inside if statement if the initial expression evaluates to True. 
...
print("\nLet's find if a number is negative, zero or positive!\n ")
...
print("\nNow let's find out if a number is negative, between 1-10, 11-20 or greater than 20!\n ")

num = float(input("Insert any other number: "))
if (num < 0):
    print("Number is negative.")
elif (num > 0):
    if (num <= 10):
